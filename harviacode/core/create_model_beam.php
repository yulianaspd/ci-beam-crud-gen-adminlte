...
$string .="\n\n    // datatables
    function datatable() {
        ...
        \$this->datatables->add_column('action', '<div class=\"text-center\"><div class=\"btn-group\">'.anchor('".$c_url."/edit/$1','<i class=\"fa fa-pencil\"></i>','class=\"btn btn-warning btn-xs\" title=\"Edit\"').anchor('".$c_url."/delete/$1','<i class=\"fa fa-trash\"></i>',' title=\"Delete\" data-button=\"delete\" class=\"btn btn-danger btn-xs\"').'</div></div>', '$pk');
