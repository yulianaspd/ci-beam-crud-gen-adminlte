...
if (isset($_POST['generate']))
{
    ...
    if ($table_name <> '')
    {
        ...
        include 'core/create_controller_beam.php';
        // include 'core/create_model.php';
        include 'core/create_model_beam.php';
        if ($jenis_tabel == 'reguler_table') {
            include 'core/create_view_list.php';
        } else {
            include 'core/create_view_list_datatables_beam.php';
            include 'core/create_controller_api_beam.php';
            // include 'core/create_view_list_datatables.php';
            // include 'core/create_libraries_datatables.php';
        }
        include 'core/create_view_form_beam.php';
