...
<head>
  ...
  <link rel="stylesheet" href="<?php echo bower_url('datatables.net-bs/css/dataTables.bootstrap.min.css'); ?>">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo site_url() ?>" class="logo">
      ...
      <span class="logo-mini"><?php echo $template['sort_title']; ?></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><?php echo $template['base_title']; ?></span>
    </a>
    ...
    <nav class="navbar navbar-static-top">
      ...
      <?php $this->load->view('layouts/nav-top'); ?>
    </nav>
  </header>
  ...
  <?php $this->load->view('logout-modal'); ?>
</div>
<!-- ./wrapper -->
    <!-- DataTables -->
    <script src="<?php echo bower_url('datatables.net/js/jquery.dataTables.min.js'); ?>"></script>
    <script src="<?php echo bower_url('datatables.net-bs/js/dataTables.bootstrap.min.js'); ?>"></script>
    <!-- SlimScroll -->
    <script src="<?php echo bower_url('jquery-slimscroll/jquery.slimscroll.min.js'); ?>"></script>
    <!-- FastClick -->
